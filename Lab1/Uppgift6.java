...
TODO: PEAK??
TODO: Does for each in the exercise instead tostring
*/
...
public class Uppgift6 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("2: Generalized Queue Delete");
            System.out.println("3: Queue IsEmpty");
            System.out.println("4: Queue Size");
            System.out.println("5: Queue Print");
            ...
            switch (choice) {
                case 1:
                    ...
                    for (int i = 0; i < characters.length(); i++) {
                        queue.insert(Integer.parseInt(characters.substring(i, i + 1)));
                    }
